...
;sound_ptr and jmp_ptr are now defined in main asm file (zero page required for indirect indexed addressing)
...
NUM_SONGS = $06 ;number of songs
                ;if you add more songs, change this number.
...
song_headers:
    ...
    .word song1_header  ;Main Game - The Guardian Legend Boss song
    .word song2_header  ;Jump sound effect
    .word song3_header  ;Title Screen - Dragon Warrior overland song
    .word song4_header  ;unused (placeholder)
    .word song5_header  ;Catch object sound effect
